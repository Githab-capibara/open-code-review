...
[Review Rules](../user-guide/05-review-rules.md) for the full priority story.
...
See [Configuration](../user-guide/03-configuration.md) for the full key reference,
...
- [QuickStart](../user-guide/01-quickstart.md) — install and run your first review.
- [Configuration](../user-guide/03-configuration.md) — env vars and config keys behind the flags.
- [Review Rules](../user-guide/05-review-rules.md) — the `--rule` flag and rule resolution.
- [Integrations](../integration/02-agent-skill.md) — calling `ocr review` from agents and CI.
