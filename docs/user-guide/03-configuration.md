...
calling — see
["No tool calls parsed" (local models / Ollama)](../user-guide/06-faq.md#no-tool-calls-parsed-local-models-ollama)
...
```bash
ocr config set language zh-CN
ocr config set language English
```

## See Also

- [QuickStart](../user-guide/01-quickstart.md) — minimal setup and first review.
- [CLI Reference](../user-guide/04-cli-reference.md) — every flag the review command accepts.
