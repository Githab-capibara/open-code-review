...
- [CLI Reference](../user-guide/04-cli-reference.md) — `ocr review --rule`, `--preview`, and `ocr rules check`.
- [Configuration](../user-guide/03-configuration.md) — config file locations and the layered resolution chain.
- [Architecture](../architecture/01-overview.md) — how the resolved rule feeds the agent prompt.
