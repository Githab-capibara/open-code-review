...
[built-in tools](../internal/03-tool.md) like `file_read` and `code_search`.
...
- [Tools](../internal/03-tool.md) — the six built-in tools MCP tools sit beside.
- [Configuration](../user-guide/03-configuration.md) — the full config file and every key.
- [CLI Reference](../user-guide/04-cli-reference.md) — `ocr config` and the review flags.
