...
> [Delegation Mode](../integration/01-delegate.md) — it lets the host agent (Claude Code)
...
3. **Fix.** Automatically apply fixes for the High/Medium items worth
   adopting. Unlike the [Agent Skill](../integration/02-agent-skill.md), this command
...
- [Agent Skill](../integration/02-agent-skill.md) — the SDK-level equivalent; same
